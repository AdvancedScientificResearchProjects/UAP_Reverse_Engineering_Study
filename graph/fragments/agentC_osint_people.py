...
E("hyp-uap-tax-3", "Banchenko 3-category UAP origin taxonomy", "hypothesis",
  ...
  description="Denis Banchenko (voice message 238104, 2026-04-06) proposed 3 origin categories as a classification vocabulary (not an empirical claim): (1) Interstellar — from another star system; canonical archive: Lazar S-4. (2) Parallel-reality / interdimensional — from a parallel branch of reality; canonical archive: Chernobrov anomalous zones. (3) Temporal — time-travellers or objects displaced in time; canonical frame: Chernobrov time-machine + ECP artifact working hypothesis 'мы следуем во времени объекта'. People-cluster is explicitly NOT one of these categories — it is an adjacent class: human-impact field around the reverse-engineering programme.",
  description_ru="Денис Банченко (голосовое сообщение 238104, 06.04.2026): 3 категории как классификационный словарь (не эмпирическое утверждение): (1) Межзвёздные; (2) Параллельная реальность / межмерные; (3) Темпоральные. Кластер людей — НЕ одна из этих категорий, а смежный класс человеческого импакта.",
