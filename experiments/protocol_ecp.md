...
**Ключевые Задачи:**
- Сбор структурированных впечатлений восприятия фрагмента НАЯ
...
| Field / Поле | Scale / Шкала | Description / Описание |
|-------------|--------------|----------------------|
| **Perceptual Impressions** | Structured Text | Sensory data description / Описание сенсорных данных |
| **Functional Hypotheses** | 0.0-1.0 Confidence | Proposed function / Предлагаемая функция |
| **Material Intuition** | Qualitative | Material properties / Свойства материала |
| **Energetic Characteristics** | 0-5 Intensity | Field/energy perception / Восприятие поля/энергии |
| **Confidence Level** | 0.0-1.0 | Self-assessed certainty / Самооценка уверенности |
| **Temporal Notes** | Timestamp | Time-based perceptions / Временные восприятия |
...
| **Level / Уровень** | L1/L2/L3/L4 |

## Perceptual Data / Данные Восприятия

### 1. Perceptual Impressions / Впечатления Восприятия
[Detailed description / Подробное описание]

### 2. Functional Hypotheses / Функциональные Гипотезы
| Hypothesis / Гипотеза | Confidence / Уверенность |
|----------------------|-------------------------|
| [Description] | 0.XX |

### 3. Energetic Characteristics / Энергетические Характеристики
| Characteristic / Характеристика | Intensity / Интенсивность |
|--------------------------------|--------------------------|
| Field Presence / Наличие Поля | X/5 |

### 4. Confidence Level / Уровень Уверенности
...
| Level / Уровень | Agreement / Согласие | Action / Действие |
|----------------|---------------------|------------------|
| **HIGH / ВЫСОКИЙ** | ≥0.7 (70%) | Primary hypothesis support / Основная поддержка гипотезы |
...
TP = True Positive (True Convergence)
FP = False Positive (Random Match)
FN = False Negative (Missed Convergence)
TN = True Negative (True Divergence)
```
...
| Raw Data Type / Тип Сырых Данных | Normalized Format / Нормализованный Формат |
|--------------------------------|------------------------------------------|
| Text descriptions / Текстовые описания | Semantic vectors / Семантические векторы |
| Confidence scores / Оценки уверенности | Normalized 0-1 scale / Нормализованная шкала 0-1 |
| Intensity ratings / Оценки интенсивности | 0-5 standardized / 0-5 стандартизировано |
| Temporal patterns / Временные паттерны | Time-series data / Временные ряды |
