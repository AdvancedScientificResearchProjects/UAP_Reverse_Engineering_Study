#!/bin/bash
set -u
cd /home/liker2/asrp-audit/UAP_Reverse_Engineering_Study/chernobrov-archive/ocr-pipeline
source .venv/bin/activate
mkdir -p out

UFO_PDF=/home/liker2/asrp-audit/UAP_Reverse_Engineering_Study/chernobrov-archive/books/downloads/enciklopediya_ufologii.pdf
VBCH_PDF=/home/liker2/asrp-audit/UAP_Reverse_Engineering_Study/chernobrov-archive/books/downloads/vremya_bessmertie_chelovek_2010.pdf
