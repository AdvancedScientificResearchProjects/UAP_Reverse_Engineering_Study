...
**EN:** This file indexes external podcast and documentary content that Denis Banchenko provided as primary-reference material on 2026-04-01 and that bears directly on UAP / Element 115 / disclosure narratives. Each entry summarises the source, links to the local raw transcript, and notes which key claims (if any) it adds to the archive.

**RU:** Этот файл индексирует внешние подкасты и документальные материалы, которые Денис Банченко предоставил как первичные справочные материалы 1 апреля 2026 г. и которые напрямую касаются нарративов UAP / Элемента 115 / disclosure. Каждая запись кратко описывает источник, ссылается на локальный сырой транскрипт и отмечает, какие ключевые утверждения (если есть) она добавляет в архив.
