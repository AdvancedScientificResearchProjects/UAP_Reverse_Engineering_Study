...
| **11. PURSUE Declassification / Рассекречивание PURSUE** | DoW/FBI/NASA/State/**CIA/DOE/ODNI** UAP records — Release 01 (161 records, 2026-05-08) + **Release 02 (64 records, 2026-05-22)** = **225 total**: 127 PDFs + 79 mp4/aud + 14 jpg; 164 per-doc cards, 8 topical syntheses, MASTER extended (§§12–14 for R02); 0 source-code overlap between releases; new agencies **CIA / DOE / ODNI** introduced in R02 / Записи DoW/ФБР/NASA/Госдеп/**ЦРУ/DOE/ODNI** — Релиз 01 (161 запись, 2026-05-08) + **Релиз 02 (64 записи, 2026-05-22)** = **225 всего**: 127 PDF + 79 mp4/aud + 14 jpg; 164 карточки по документам, 8 тематических синтезов, MASTER расширен (§§12–14 для R02); 0 пересечений кодов между релизами; новые ведомства **ЦРУ / DOE / ODNI** впервые в R02 | Available / Доступно | [`war-gov-pursue-archive/README.md`](war-gov-pursue-archive/README.md) |
...
![ECP response agreement matrix](charts/ecp_response_agreement_matrix.svg)
...
![ECP reference validation matrix](charts/ecp_reference_validation_matrix.svg)
...
![Lazar S-4 contractor bridge / Мост подрядчика Lazar S-4](corporate-economic-analysis/diagrams/rendered/lazar_s4_contractor_bridge.png)
...
![Fuel-supply-chain closed loop / Замкнутый контур цепочки топливоснабжения](corporate-economic-analysis/diagrams/rendered/dubna_lazar_amentum_llnl_fuel_loop.png)
...
**EN:** Public-source literature catalog consolidating peer-reviewed UAP physics + sensor-analysis papers, peer-reviewed social-science / history-of-ufology works, government reports (DNI/ODNI, AARO, NASA), grey literature (NIDS, AAWSAP/AATIP, SCU collected), and observation-program technical outputs (Galileo Project, Hessdalen, UAPx). v6 inventory: **~37 source-provenance entries** — 13 v4 baseline (Kean, Pasulka, Eghigian, Wendt-Duvall, NASA UAP 2023, ODNI 2021-2024, AARO public reports, Hessdalen papers, Nimitz FLIR analyses, Galileo Project papers, SCU collected papers, plus 2 cross-references back to Track 7 theoretical-foundations) + 5 v5 Banchenko Arcanum-12 cycle entries + **17 v6 HIGH-priority Perplexity-research-audit additions** (Knuth 2025 PiAS landmark, Watters/Loeb/Laukien 2023 multimodal observatories, Domine 2025 Galileo all-sky IR, Szydagis 2025 UAPx, Knuth/Powell/Reali 2019 Nimitz physics, Bruehl/Villarroel 2025 POSS-I + nuclear, Medina/Brewer/Kirkpatrick 2023 environmental, Grosvenor/Hancock/Porritt 2025 atomic-complex, Hancock 2023 SCU pattern recognition, Vallée 1998 material samples, Powell 2022 Ubatuba isotope, Powell 2019 Nimitz forensic, Lomas 2025 assessment matrix, Nolan/Vallée 2022 PiAS isotopic, Vallée/Dini/Mestchersky 2025 PiAS radiative-energy, AARO/AUI 2025 workshop, GEIPAN database) + **2 v6 adversarial-balance additions** (Condon Report 1968, USAF Blue Book Archives subsuming SIGN/GRUDGE/Twinkle predecessors). Corpus is **seed-level**, with v7+ expansion planned (eLibrary.ru / ResearchGate / Academia.edu broader pull; cross-archive integration of Track 1 isotope-pipeline and Track 7 fuel-supply-chain). Does NOT validate cataloged claims; consolidates them so the broader research can reference a stable provenance register.
