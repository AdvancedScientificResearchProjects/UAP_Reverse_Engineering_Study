...
│   ├── README.md
│   ├── analysis/                      # 6 analysis files (industry / EG&G→Amentum / Lazar bridge / methodology / patents / adversarial OSINT)
...
│   ├── diagrams/rendered/             # 7 diagrams (3 v1 + 4 v3) / 7 диаграмм (3 v1 + 4 v3)
